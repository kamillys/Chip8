...
public:
    ...
    int setVx(uint8_t x, uint8_t v) { m_Regs[x] = v; return 1;} //TODO:
    uint16_t pc() {return m_Pc;}
    int setPc(uint16_t v) { m_Pc = v; return 1;} //TODO:
    uint16_t I() { return m_I;}
    int setI(uint16_t v) {m_I = v; return 1;} //TODO:
    uint16_t Sp() { return m_Sp;}
    int addSp() {m_Sp++; return 1;} //TODO:
    int decSp() {m_Sp--; return 1;} //TODO:
